...
(function (context) {
  ...
  TheGraph.Edge = React.createFactory(React.createClass({
    ...
    componentDidMount: function () {
      ...
      // Dragging
      domNode.addEventListener('track', this.dontPan);
    ...
    dontPan: function (event) {
      ...
      if (event.detail.state === 'start' && this.props.app.menuShown) {
    ...
    showContext: function (event) {
      ...
      var y = event.y - this.props.app.props.offsetX || event.clientY - this.props.app.props.offsetX || 0;
